Feature: Remove Option on children
  ...
  Background:
    ...
    And the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" has the following Options
      ...
      | 4bb8b866-2137-4f10-8604-c7acb850d682 | 55847dfc-93cb-4fa8-b164-5ae66bdb60d2 | 26.50 | AVAILABLE |
  ...
  Scenario: Removing an Option on children successfully
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to remove an Option with the Id "4bb8b866-2137-4f10-8604-c7acb850d682" from child with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then the Option with the Id "4bb8b866-2137-4f10-8604-c7acb850d682" should be removed from Offer's children

  Scenario: Failure in removing an Option on children when the parent Customization doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to remove an Option with the Id "4bb8b866-2137-4f10-8604-c7acb850d682" from child with the Id "4bb8b866-2137-4f10-8604-c7acb850d689" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then I should encounter a "CustomizationNotFoundException" error

  Scenario: Failure in removing an Option from child when the Store doesn't exist
    Given the Id of the Store is "2c371f9f-ea24-421b-803d-5e477caf8e34"
    When I attempt to remove an Option with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" from child with the Id "4bb8b866-2137-4f10-8604-c7acb850d689" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then I should encounter a "StoreNotFoundException" error

  Scenario: Failure in removing an Option from child when the Offer doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to remove an Option with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" from child with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" in the Offer with the Id "edcf7543-f4e7-44f7-8d72-9d51b75d4b0f"
