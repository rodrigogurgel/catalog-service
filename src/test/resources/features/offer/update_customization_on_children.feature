Feature: Update Customization on children
  ...
  Background:
    Given that there is the following Products in the Store with the Id "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
      ...
      | 55847dfc-93cb-4fa8-b164-5ae66bdb60d2 | Produto2 de teste | Produto2 para testes | AVAILABLE | https://www.image1.com.br |
    And the following Customizations
      ...
      | 693038f4-85d9-4e01-b8c8-ee503d7cadc2 | Customization2 de teste | Customization para testes | AVAILABLE |
    ...
    And the Option with the Id "4bb8b866-2137-4f10-8604-c7acb850d686" has the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2"
  ...
  Scenario: Updating a Customization on children successfully
    ...
    When I attempt to update a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" on children with the Id "4bb8b866-2137-4f10-8604-c7acb850d686" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" should be updated in the offer

  Scenario: Failure in updating a Customization on children when the parent Option doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to update a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" on children with the Id "4bb8b866-2137-4f10-8604-c7acb850d687" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then I should encounter a "OptionNotFoundException" error

  Scenario: Failure in updating a Customization on children when the Store doesn't exist
    Given the Id of the Store is "2c371f9f-ea24-421b-803d-5e477caf8e34"
    When I attempt to update a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" on children with the Id "4bb8b866-2137-4f10-8604-c7acb850d687" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then I should encounter a "StoreNotFoundException" error

  Scenario: Failure in updating a Customization on children when the Offer doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to update a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" on children with the Id "4bb8b866-2137-4f10-8604-c7acb850d687" in the Offer with the Id "edcf7543-f4e7-44f7-8d72-9d51b75d4b0f"
    Then I should encounter a "OfferNotFoundException" error

  Scenario: Failure in updating a Customization on children when the Product doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    And the following Customizations
      | id                                   | name                    | description               | status    |
      | 693038f4-85d9-4e01-b8c8-ee503d7cadc2 | Customization2 de teste | Customization para testes | AVAILABLE |
