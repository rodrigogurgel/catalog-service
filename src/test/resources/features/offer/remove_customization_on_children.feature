Feature: Remove Customization on children
  ...
  Scenario: Removing a Customization on children successfully
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to remove a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" from child with the Id "4bb8b866-2137-4f10-8604-c7acb850d686" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" should be removed from Offer's children

  Scenario: Failure in removing a Customization on children when the parent Option doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to remove a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc2" from child with the Id "4bb8b866-2137-4f10-8604-c7acb850d689" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then I should encounter a "OptionNotFoundException" error

  Scenario: Failure in removing a Customization from child when the Store doesn't exist
    Given the Id of the Store is "2c371f9f-ea24-421b-803d-5e477caf8e34"
    When I attempt to remove a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" from child with the Id "4bb8b866-2137-4f10-8604-c7acb850d689" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then I should encounter a "StoreNotFoundException" error

  Scenario: Failure in removing a Customization from child when the Offer doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to remove a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" from child with the Id "4bb8b866-2137-4f10-8604-c7acb850d686" in the Offer with the Id "edcf7543-f4e7-44f7-8d72-9d51b75d4b0f"
