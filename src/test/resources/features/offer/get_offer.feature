Feature: Get Offer
  ...
  Scenario: Getting an Offer successfully
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to get an Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686" should be retrieved from database
  ...
  Scenario: Failure in getting an Offer when the Offer doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to get an Offer with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc"
