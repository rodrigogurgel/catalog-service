Feature: Update Customization
  ...
  Scenario: Updating a Customization successfully
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    And the the following Customizations
      | id                                   | name                    | description               | status    |
      | 693038f4-85d9-4e01-b8c8-ee503d7cadcc | Customization2 de teste | Customization para testes | AVAILABLE |
    And the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" has the following Options
      | id                                   | product_id                           | price | status    |
      | 4bb8b866-2137-4f10-8604-c7acb850d686 | 55847dfc-93cb-4fa8-b164-5ae66bdb60d1 | 26.50 | AVAILABLE |
    When I attempt to update a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" from the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" should be updated from the Offer

  Scenario: Failure in updating a Customization from the Offer when the Store doesn't exist
  ...
  Scenario: Failure in updating a Customization from the Offer when the Offer doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    And the the following Customizations
      | id                                   | name                    | description               | status    |
      | 693038f4-85d9-4e01-b8c8-ee503d7cadcc | Customization2 de teste | Customization para testes | AVAILABLE |
    And the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" has the following Options
      | id                                   | product_id                           | price | status    |
      | 4bb8b866-2137-4f10-8604-c7acb850d686 | 55847dfc-93cb-4fa8-b164-5ae66bdb60d1 | 26.50 | AVAILABLE |
    When I attempt to update a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" from the Offer with the Id "edcf7543-f4e7-44f7-8d72-9d51b75d4b0f"
    Then I should encounter a "OfferNotFoundException" error

  Scenario: Failure in updating a Customization from the Offer when the Product doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    And the the following Customizations
      | id                                   | name                    | description               | status    |
      | 693038f4-85d9-4e01-b8c8-ee503d7cadcc | Customization2 de teste | Customization para testes | AVAILABLE |
