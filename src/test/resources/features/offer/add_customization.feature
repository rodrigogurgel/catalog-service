Feature: Add Customization
  ...
  Scenario: Adding a Customization successfully
    ...
    When I attempt to add a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
    Then the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" should be added in the offer

  Scenario: Failure in adding a Customization when the Store doesn't exist
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to add a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadcc" in the Offer with the Id "edcf7543-f4e7-44f7-8d72-9d51b75d4b0f"
  ...
  Scenario: Failure in adding a Customization when the Product doesn't exist
    ...
    And the following Customizations
      | id                                   | name                   | description               | status    |
      | 693038f4-85d9-4e01-b8c8-ee503d7cadc8 | Customization de teste | Customization para testes | AVAILABLE |
    And the Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc8" has the following Options
      | id                                   | product_id                           | price | status    |
      | 4bb8b866-2137-4f10-8604-c7acb850d688 | edcf7543-f4e7-44f7-8d72-9d51b75d4b0f | 26.50 | AVAILABLE |
    When I attempt to add a Customization with the Id "693038f4-85d9-4e01-b8c8-ee503d7cadc8" in the Offer with the Id "4bb8b866-2137-4f10-8604-c7acb850d686"
