Feature: Count Products
  ...
  Scenario: Counting Products successfully
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to count the Products with the begins with as "Product"
    Then the Products should be counted in the database with the begins with as "Product"
  ...
  Scenario: Failure in getting a Products when the begins with parameter has length less than 3 characters
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to count the Products with the begins with as "Pr"
