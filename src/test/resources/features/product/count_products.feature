Feature: Get Product
  ...
  Scenario: Getting Products successfully
    ...
    When I attempt to count the Products with the limit as "1", offset as "1" and begins with as "Product"
    Then the Products should be counted in the database with the limit as "1", offset as "1" and begins with as "Product"

  Scenario: Getting Products successfully when the limit parameter is negative
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to count the Products with the limit as "-1", offset as "1" and begins with as "Product"
    Then the Products should be counted in the database with the limit as "0", offset as "1" and begins with as "Product"

  Scenario: Getting Products successfully when the limit parameter is greater then 20
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to count the Products with the limit as "21", offset as "1" and begins with as "Product"
    Then the Products should be counted in the database with the limit as "20", offset as "1" and begins with as "Product"

  Scenario: Getting Products successfully when the offset parameter is negative
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to count the Products with the limit as "21", offset as "-1" and begins with as "Product"
    Then the Products should be counted in the database with the limit as "20", offset as "0" and begins with as "Product"
  ...
  Scenario: Failure in getting a Products when the begins with parameter has length less than 3 characters
    Given the Id of the Store is "259f3a2d-12d2-4b4d-9e10-0e59efb378a9"
    When I attempt to count the Products with the limit as "1", offset as "1" and begins with as "Pr"
